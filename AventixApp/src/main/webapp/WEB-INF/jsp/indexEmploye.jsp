      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><a href="pages-profile.html"><img src="img/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
            <h2 class="h5">${prenom} ${nom}</h2><span>${statut}</span>
          </div>
          <!-- Small Brand information, appears on minimized sidebar-->
          <div class="sidenav-header-logo"><a href="indexEmployeEmploye.html" class="brand-small text-center"> <strong>A</strong><strong class="text-primary">D</strong></a></div>
        </div>
